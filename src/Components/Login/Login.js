        ...
        <div className="flex justify-center h-screen">
            <div className="hidden bg-cover lg:block lg:w-2/3 bg-[url('./assets/Login.png')] bg-white">
                <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-0">
                    <div>   
                        <h2 className="text-4xl font-bold text-black shadow-black">Uidai</h2>
            ...
            <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                <div className="flex-1">
                    <div className="text-center">
                        <h2 className="text-4xl font-bold text-center text-gray-700 ">Uidai</h2>
                    ...
                    <div className="mt-8">
                        ...
                        <p className="mt-6 text-sm text-center text-gray-400">Don&#x27;t have an account yet? <a href="/SignUp" className="text-amber-600 focus:outline-none focus:underline hover:underline">Sign up</a>.</p>
                    </div>
                </div>
            </div>
        </div>
